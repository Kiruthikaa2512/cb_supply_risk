...
WWW, FIGS = Path(__file__).parent / "www", ROOT / "outputs/figures"
df = pd.read_csv(ROOT / "data/raw/cross_border_ecommerce_supply_chain_dataset.csv")
pkg = joblib.load(ROOT / "notebooks/outputs/models/delivery_delay_logistic_model.joblib")
